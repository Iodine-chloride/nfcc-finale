...
tag @e[tag=bingo_table_entry,tag=player_3] add red
...
tag @e[tag=bingo_table_entry,tag=player_11] add red

tag @e[tag=bingo_table_entry,tag=player_2] add blue
tag @e[tag=bingo_table_entry,tag=player_4] add blue
...
tag @e[tag=bingo_table_entry,tag=player_12] add blue
...
team join red @a[limit=1,team=,scores={bingo_player=3}]
team join blue @a[limit=1,team=,scores={bingo_player=4}]
...
team join red @a[limit=1,team=,scores={bingo_player=11}]
team join blue @a[limit=1,team=,scores={bingo_player=12}]
