...
title @a title [{"text":"B.I.N.G.O","color":"green","bold":true}]
title @a subtitle [{"text":"绿队","color":"green","bold":true},{"text":"获得了胜利!","color":"gold"}]
tellraw @a[team=green,tag=!spec] [{"text":"+333","color":"green"},{"text":"⭐","color":"yellow"},{"text":"（获胜）","color":"gold"}]
scoreboard players add @a[team=green] round_score_mb 333
