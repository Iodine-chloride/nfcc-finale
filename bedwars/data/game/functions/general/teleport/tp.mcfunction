...
tp @a[tag=red] @e[tag=red_spawn,limit=1]
tp @a[tag=blue] @e[tag=blue_spawn,limit=1]
tp @a[tag=green] @e[tag=green_spawn,limit=1]
tp @a[tag=yellow] @e[tag=yellow_spawn,limit=1]
