...
execute in game:custom run tp @a -1090 91 -252
execute in game:custom run spawnpoint @a -1090 91 -252
execute in game:custom run worldborder center -1094 -257
execute in game:custom run worldborder set 256
...
scoreboard players set CHOSEN_MAP data 402
