...
function hall:vote/results/animations/survival_games/1

tellraw @a [{"text":"[⭐]"},{"text":"投票结果计算完毕！获胜的小游戏是：","color":"yellow"},{"text":"Survival Games","color":"green"},{"text":"！","color":"yellow"}]

tellraw @a {"text":"你将在10秒后被传送至对应的小游戏房间，请等待...","color":"red"}
tellraw @a {"text":"(该游戏传送时可能会发生较严重卡顿，请见谅！)","color":"gray","italic":true,"bold":true}
schedule function hall:lobbies/enter_hunger_games 10s